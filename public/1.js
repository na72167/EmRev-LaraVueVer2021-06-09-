...
/* harmony import */ var _utils_validate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/validate */ "./resources/js/components/auth/utils/validate.js");
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 10:
                if (_this.signUpFormResult.emailResult === true && _this.signUpFormResult.passwordResult === true) // ロード画面実装処理
                  // this.$store.dispatch("app/setLoading");
                  _this.Validation = "";

              case 11:
                console.log("登録処理に入りました。");
                console.log(_this.signUpForm); // 登録処理

                _this.$store.dispatch("auth/createUser", _this.signUpForm); //バリテーション結果の初期化
...
/* harmony import */ var _auth_SignUp__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../auth/SignUp */ "./resources/js/components/auth/SignUp.vue");
/* harmony import */ var _auth_Login__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../auth/Login */ "./resources/js/components/auth/Login.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    SignUp: _auth_SignUp__WEBPACK_IMPORTED_MODULE_1__["default"],
    Login: _auth_Login__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
...
/*!********************************************************!*\
  !*** ./resources/js/components/auth/utils/validate.js ***!
  \********************************************************/
/*! exports provided: validURL, validLowerCase, validUpperCase, validAlphabets, validEmail, validPassword, validNum, validNonLeadingZero, validZip, validTel, validHalfNumAlp, validNumber, validWhiteSpace */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
