  ...
  <section class="passrePasswordReminder">
    <div class="passreReminder__content">
      ...
      <form @submit.prevent="passwordReminder">
        ...
        <input class="passrePasswordReminder__input" :class="{ errInput: Validation.passwordReminderEmailErrMsg }" type="text" placeholder="ここにメールアドレスを入力" v-model="passwordReminderForm.email">
        ...
        <button type="submit" class="passrePasswordReminder__content-bottom">
